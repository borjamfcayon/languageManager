        ...
        <div className="min-h-96 px-8 py-6 mt-4 text-left bg-white dark:bg-gray-900 rounded-xl shadow-xl">
          <div className="flex flex-col justify-center items-center h-full select-none">
            <div className="flex flex-col items-center justify-center gap-2 mb-8">
              ...
              {!register ? (
                <p className="text-xs text-gray-400 dark:text-gray-300 cursor-pointer hover:text-blue-400" onClick={() => setRegister(true)}>Regístrate en la plataforma</p>
              ) : (
                <p className="text-xs text-gray-400 dark:text-gray-300 cursor-pointer hover:text-blue-400" onClick={() => setRegister(false)}>Ingresa a tu cuenta</p>
              )}
            </div>
            {!register ? (
              <>
            ...
            <div className="mt-5">
              <button
                ...
                onClick={() => !register ? handleSignIn(email, password) : handleRegister()}
                disabled={loading}
              >
                {loading ? <Loader2 /> : !register ? 'INICIAR SESION' : 'REGISTRARSE'}
              </button>
            </div>
          </div>
        </div>
